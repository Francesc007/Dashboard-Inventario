...
const EVENTS: { type: TrackEventType; label: string; description: string }[] =
  [
    {
      type: "view_car",
      label: "Ver auto",
    ...
    },
    {
      type: "click_whatsapp",
      label: "WhatsApp",
      description: "Clic en botón o enlace a WhatsApp",
    },
    {
      type: "click_form",
      label: "Formulario",
      description: "Clic para abrir o enviar el formulario de contacto",
    },
  ];
...
export function LandingTrackButtons() {
  ...
  const [pending, setPending] = useState<TrackEventType | null>(null);

  async function send(type: TrackEventType) {
    setLastSent(null);
    setPending(type);
