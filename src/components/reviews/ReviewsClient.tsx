        ...
        {modal && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md rounded-2xl border border-white/[0.08] bg-[#0c0e18] p-6 shadow-2xl"
            >
              ...
              <div className="mt-4 space-y-3 text-sm">
                <label className="block">
                  <span className="text-xs text-zinc-500">Vehículo (opcional)</span>
                  <select
                ...
                <label className="block">
                  <span className="text-xs text-zinc-500">Modelo (texto)</span>
                  <input
                    className="mt-1 w-full rounded-lg border border-white/[0.08] bg-black/30 px-3 py-2 text-white"
                    value={form.model}
                    onChange={(e) =>
                ...
                <label className="block">
                  <span className="text-xs text-zinc-500">Comentario</span>
                  <textarea
                    rows={4}
                    className="mt-1 w-full rounded-lg border border-white/[0.08] bg-black/30 px-3 py-2 text-white"
                    value={form.comment}
